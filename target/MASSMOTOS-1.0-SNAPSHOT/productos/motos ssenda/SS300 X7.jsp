...
<!-- modificar todo el main -->
    <main>
        <img src="imagenes ssenda/X7.jpg" alt="SS300 X7">
        <div class="contenido">
            <h2>SSENDA SS300 X7</h2>
            <li>La Ssenda X7 300 EFI presenta un diseño completamente deportivo con líneas aerodinámicas que no solo mejoran su estética, sino también su rendimiento en carretera. Su posición de manejo inclinada y su asiento a 77 cm del suelo ofrecen una experiencia de conducción cómoda y estable. Los aros de aleación de magnesio y las llantas sin cámara contribuyen a una mayor seguridad y maniobrabilidad.</li>
            <ul>
                <h3>Especificaciones detalladas:</h3>
                <h3>MOTOR: </h3>
                    <li>
                        <P>✔ Tipo: 4 tiempos OHC Euro III</P>
                        <p>✔ Cilindrada (cc): 300 CC  </p> 
                        <P>✔ Potencia (Hp): 23 HP</P>
                ...
                <li><P>✔ Freno delantero: Discos dobles Ventilados</P>
                    <P>✔ Freno posterior: Disco Ventilado </P>
