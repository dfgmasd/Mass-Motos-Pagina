...
<body>
    ...
    <!-- Contenido principal -->
    <main>
        <img src="${pageContext.request.contextPath}/imagenes/motos/bajaj/pulsar%20180%20neon.jpg" alt="PULSAR 180 NEON">
        <div class="contenido">
            <h2>PULSAR 180 NEON</h2>
            <ul>
                <li>Te presentamos la Pulsar 180 Neon. Su motor de 180 cc es ideal para transporte urbano y carretera. Su inyección electrónica permite reducir el consumo de combustible significativamente.</li>
            </ul>
            <ul>
                <h3>Especificaciones detalladas:</h3>
                <h3>MOTOR:</h3>
                <li>
                    <p>✔ Tipo: Monocilíndrico, 4 tiempos</p>
                    <p>✔ Cilindrada (cc): 178.6 cc</p> 
                    <p>✔ Potencia (Hp/rpm): 16.78 HP @ 8500 RPM</p>
                    <p>✔ Torque máximo (Nm/rpm): 13.4 @ 6000 (Nm @ RPM)</p>
                    <p>✔ Transmisión: 5 velocidades</p>
                    <p>✔ Sistema de arranque: Eléctrico</p>
                </li> 
                <h3>CHASIS Y FRENOS:</h3>       
                <li>
                    <p>✔ Freno delantero: Disco 260 mm</p>
                    <p>✔ Freno posterior: Tambor 130 mm</p>
                    <p>✔ Suspensión delantera: Telescópica extensión de 130 mm</p>
                    <p>✔ Suspensión posterior: Doble amortiguación Nitrox</p>
                    <p>✔ Capacidad de tanque: 15 Litros</p>
                </li>
            </ul>
            <p id="price">Precio: S/ 9,459</p>
            <button onclick="agregarAlCarrito('PULSAR 180 NEON', 9459)">Agregar al Carrito</button>
        </div>
    </main>
