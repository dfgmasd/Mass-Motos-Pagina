...
<!-- modificar todo el main -->
    <main>
        <img src="imagenes/rodilleras.jpg" alt="Rodilleras">
        <div class="contenido">
            <h2>Rodilleras K12 para motociclista Scoyco</h2>
            <li>Rodilleras para motociclista K12 marca Scoyco fabricado en material policarbonato y poliester.</li>
            <ul>
                <h3>DESCRIPCION: </h3>
                    <li>
                        <P>Marca: SCOYCO</P>
                        ...
                        <P>Medida: Estándar</P>
                        <P>Color: Negro</P>
                        <P>Material: Policarbonato / Poliester</P>
                    </li> 
            </ul>
            <p id="price">Precio: S/. 160,00</p>
