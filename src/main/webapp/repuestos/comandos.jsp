...
<!-- modificar todo el main -->
    <main>
        <img src="imagenes/comandos.jpg" alt="Candado">
        <div class="contenido">
            <h2>Par de comandos</h2>
            <li>Comandos marca Volda fabricados en material plástico. Derecho e izquierdo para arranque y luces.</li>
            <ul>
                <h3>DESCRIPCION: </h3>
                    <li>
                        <P>Marca: VOLDA</P>
