...
<!-- modificar todo el main -->
    <main>
        <img src="imagenes/amortiguador.jpg" alt="Amortiguador">
        <div class="contenido">
            <h2>Amortiguador doble resorte Volda</h2>
            <li>Juego de Amortiguador posterior para moto con doble resorte marca Volda, fabricados en acero.</li>
            <ul>
                <h3>DESCRIPCION: </h3>
                    <li>
                        <P>Marca: Volda</P>
                        <p>Marca: Volda
                            Modelo: Doble resorte  </p> 
                        <P>Material: Acero</P>
                    </li> 
            </ul>
            <p id="price">Precio: S/. 80,00</p>
            <button onclick="agregarAlCarrito('Amortiguador Doble', 80.00)">Agregar al Carrito</button>
        </div>
    </main>
    <footer>
