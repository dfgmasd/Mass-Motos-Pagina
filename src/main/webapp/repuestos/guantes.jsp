...
<!-- modificar todo el main -->
    <main>
        <img src="imagenes/guantes.jpg" alt="Guantes">
        <div class="contenido">
            <h2>Guantes mitones para motociclista Kmazter</h2>
            <li>Guantes para motociclista tipo mitones (sin dedos) marca KMAZTER fabricados en material poliester.</li>
            <ul>
                <h3>DESCRIPCION: </h3>
                    <li>
                        <P>Marca: KMAZTER</P>
