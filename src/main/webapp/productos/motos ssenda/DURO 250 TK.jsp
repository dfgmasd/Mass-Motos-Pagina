...
<!-- modificar todo el main -->
    <main>
        <img src="imagenes ssenda/tk 250.avif" alt="DURO 250 TK">
        <div class="contenido">
            <h2>SSENDA DURO 250 TK</h2>
            <li>La nueva Ssenda Duro 250 TK es una motocicleta de la categoría doble propósito con un estilo y diseño totalmente renovado. Está equipada con potentes neblineros, un tablero digital y colores muy vistosos. Ssenda nos ofrece una nueva opción para nuestras aventuras y trayectos por la ciudad, con un motor capaz de alcanzar los 25hp de potencia.</li>
            <ul>
                <h3>Especificaciones detalladas:</h3>
                <h3>MOTOR: </h3>
                    <li>
                        <P>✔ Tipo:  4 tiempos OHC EURO III- 4 Válvulas</P>
                        <p>✔ Cilindrada (cc): 250 CC  </p> 
                        <P>✔ Potencia (Hp): 25 HP</P>
                ...
                <li><P>✔ Freno delantero: : Disco Ventilado y Lobulado</P>
                    <P>✔ Freno posterior: Disco Ventilado y Lobulado</P>
                    <P>✔ Suspensión delantera: Horquillas telescópicas invertidas </P>
                    <P>✔ Suspensión posterior: Amortiguador central (Monoshock)</P>
                    <P>✔ Capacidad de tanque: 3.69 galones</P>
                    </li>
            </ul>
            <p id="price">Precio: S/.8,125</p>
