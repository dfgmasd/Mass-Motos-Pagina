...
<!-- modificar todo el main -->
    <main>
        <img src="imagenes ssenda/gol 125.jpeg" alt="GOL 125">
        <div class="contenido">
            <h2>SSENDA GOL 125</h2>
            <li>Muévete por la ciudad con estilo y, sobre todo, con mucha solvencia aún en medio de una caótica congestión, con esta unidad de Ssenda métele un Gol-azo al trafico.</li>
            <ul>
                <h3>Especificaciones detalladas:</h3>
                <h3>MOTOR: </h3>
                    <li>
                        <P>✔ Tipo: 4 tiempos OHC A cadenilla</P>
                        <p>✔ Cilindrada (cc): 125 CC  </p> 
                        <P>✔ Potencia (Hp): 8.04 HP</P>
                        <P>✔ Sistema de arranque: Electrico y a Patada</P>
                    </li> 
                 <h3>CHASIS Y FRENOS :</h3>       
                <li><P>✔ Freno delantero: Disco Ventilado con cáliper de doble pistón</P>
                    <P>✔ Freno posterior: Tambor Mecánico con zapatas expandibles</P>
                    <P>✔ Suspensión delantera: Horquillas telescópicas </P>
                    <P>✔ Suspensión posterior: Doble amortiguador lateral</P>
                    <P>✔ Capacidad de tanque: 1 galon</P>
                    </li>
            </ul>
            <p id="price">Precio: S/. 4,590</p>
